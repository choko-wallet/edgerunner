...
const generateOrRefreshAccount = async (
  ...
  const cert = await validateOAuthProofOfOwnership("google", userCredential, token);
  ...
  if (
    await preimageOAuthProofOfOwnership("google", userCredential)
  ) {
    ...
    await confirmOAuthProofOfOwnership("google", userCredential, token);
    return key;
  }
};
